               ...
               <div class="contact-left">
                ...
                <form id="registerid" onsubmit="return false">
                  <div id="suggestions" class="suggestions">
                    ...
                    <input id="sendesugg" type="button" @click="login2"  class="send-message-cta" value="Signup" >
                  </div>
                </form>
            </div>
            </div>
  ...
  methods: {
    ...
    async login () {
      ...
      if (allAreFilled) {
        ...
        await axios.post('https://kabelodatabase.herokuapp.com/loginnako', {
