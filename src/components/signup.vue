  ...
  <div class="price">
    ...
    <div class="navbar">
        <div class="container">
            ...
            <!--<img  class="logo" src="../assets/saki.jpeg" width="20%"  height="20%" alt="Open Navigation">-->
    ...
    async register () {
      if (this.signupPass === this.signupPassCon) {
        ...
        if (allAreFilled) {
          ...
          await axios.post('https://kabelodatabase.herokuapp.com/registernako', {
            name: this.signname,
            ...
            .then((response) => {
              ...
              if (response.data === 'Invalid email') {
                ...
                this.signnumber = ''
                this.signupPassCon = ''
                window.location.href = 'https://travelsakireminder.web.app/#/'
              }
            }, (error) => {
              console.log(error)
            })
